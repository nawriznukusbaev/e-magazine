    ...
    return (
        <div className="container-xl flex flex-col">
            <div className="flex flex-row my-[20px]">
                <p className="text-3xl font-bold">{dataSingleProduct.name}</p>
            </div>
            <div className="flex flex-row">
                <div className="flex flex-row w-[45%]">
                    <div className="flex flex-col w-[67px] mr-[50px]">
                        {dataSingleProduct.images.map((item)=>{
                    ...
                    <div className="flex flex-col w-[calc(100%-67px)] ">
                        <div className="w-[415px]">
                            <img src={dataSingleProduct.images[0].image_path}/>
                        </div>
                    </div>
                </div>
                <div className="flex flex-row w-[55%]">
                    ...
                    <div className="flex flex-col w-[50%] p-[20px] rounded-md shadow-2xl">
                        <p className="text-2xl font-bold mb-[15px]">{dataSingleProduct.price} UZS</p>
